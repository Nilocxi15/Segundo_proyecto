...
public class addUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        positionComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5" }));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        // TODO add your handling code here:
        position = Integer.parseInt(positionComboBox.getSelectedItem().toString());
        if (user.getName(position) != null) {
            JOptionPane.showMessageDialog(null, "Ya hay un usuario en este espacio", "ERROR", JOptionPane.WARNING_MESSAGE);
            return;
        } else {
            user.setName(nameTextField.getText(), position);
            accesScreen accessFrame = new accesScreen();
            accessFrame.setVisible(true);
            this.dispose();
        }
